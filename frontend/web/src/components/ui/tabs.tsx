...
/** Tabs root; value/onValueChange control the active tab. */
...
/** Style variants for the tab list. */
...
/** A single tab trigger; selecting it activates its panel. */
...
/** Panel rendered when its tab is active. */
