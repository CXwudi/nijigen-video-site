...
- Run:
  ...
  deno fmt \
    "../design-log/plans/plan-issue-5-apps-api-spring-boot-setup-20260329.md" \
...
| [design-log/adl/001-project-structure-baseline.md](../adl/001-project-structure-baseline.md)                                                                                                                                                                                                                                                                                                                                                       | Backend shape decision showing `backend/apps/api` as a real runtime app and `modules/*` as the shared-code home                                                                                             | Must Read          |
