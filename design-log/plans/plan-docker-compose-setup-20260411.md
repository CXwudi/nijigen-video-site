...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| [design-log/spec/spec-docker-compose-setup-20260411.md](../spec/spec-docker-compose-setup-20260411.md)                                                         | Approved design spec for the Docker Compose setup and the primary source of truth for this refreshed plan.                               | Must Read          |
...
| [backend/docker/Dockerfile](../../backend/docker/Dockerfile)                                                                                                   | Backend app-family Dockerfile for the approved JVM and native multi-target design.                                                       | Must Read          |
